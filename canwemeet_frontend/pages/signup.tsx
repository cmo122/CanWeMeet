...
export default function SignUp() {
  ...
  const { register, handleSubmit, setError, formState: { errors } } = useForm<SignupValues>()
          ...
          bg-[rgba(255,255,255,0.5)] shadow-md backdrop-blur-sm rounded-lg h-[35rem]">
            ...
            onSubmit={handleSubmit(onSubmit)}>
              ...
              <label htmlFor="confirmPassword" className="text-xl text-white"> Confirm Password
                ...
                {errors.password?.type==="minLength" && <p role="alert" className='text-red-500'>Password is too short</p>}
